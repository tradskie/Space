...
import Logoimg from '../../assets/ohm/Space logo-01.png'
...
<video autoPlay loop muted
    ...
    <img src={Logoimg} alt="" className="logo" />
      <ul className="uls">
        ...
        <li className="lis"><a className="a" href="https://spacemoneydapp.gitbook.io/space-dao/info/faq">FAQs</a></li>
        <li className="lis"><a className="a" href="https://spacemoneydapp.gitbook.io/space-dao/">Get Involved</a></li>
      </ul>
      ...
      >
        ...
        {/* <a href="https://spacemoneydapp.gitbook.io/space-dao/" target="_blank"><img src={ShenJiImg1} alt="" className="shenji" /></a>
        <a href="https://spacemoneydapp.gitbook.io/space-dao/" target="_blank"><img src={ShenJiImg2} alt="" className="shenji" /></a> */}
      </div>
    ...
    <div className="boodyBox fxColumn">
      ...
      <div style={{ height: 30 }}></div>
        ...
        Space Dao is a decentralized reserve currency protocol based on the SPACE token and aims at building a community-owned decentralized financial infrastructure for the crypto world.
      </div>   
      <div className="fxBetween">
        <a href="../stake" className="btnBox_1">Enter App</a>
        <a href="https://spacemoneydapp.gitbook.io/space-dao/" className="btnBox_2 a" target="_blank">Documentation</a>
      </div>
    ...
    <div className="bottomBor a">
      <a href="https://twitter.com/spacemoney9" target="_blank" className="bottomImgs a2"><img src={img1_1} alt="" className="bottomImgs2" /></a>
      <a href="https://github.com/SpaceMoneydApp/SpaceDao" target="_blank" className="bottomImgs a2"><img src={img1_2} alt="" className="bottomImgs2" /></a>  
      <a href="https://discord.gg/WrmDhSHt" target="_blank" className="bottomImgs a2"><img src={discord} alt="" className="bottomImgs2" /></a>
      <a href="https://t.me/SpaceDaoDapp" target="_blank" className="bottomImgs a"><img src={img1_4} alt="" className="bottomImgs2" /></a>
    </div> 
    {menu ?
      <div className="moban" onClick={() => ShowhideClick()} >
        <div className="CaiDanlieBiao">
          ...
          <div className="lis2"><a target="_blank" className="a" href="https://spacemoneydapp.gitbook.io/space-dao/info/faq">FAQs</a></div>
          <div className="lis2"><a target="_blank" className="a" href="https://spacemoneydapp.gitbook.io/space-dao/">Get Involved</a></div>
...
function Inp_Box({idoBalance,busdAmount}) {
  ...
  return <MinInp_Box>
    ...
    <div className="Content_Box2">
      <div>ITO Quota</div>
      <input type="text" placeholder={`${idoBalance}SPACE`} className="InpStyle" />
    </div>
    <div className="Content_Box2">
      <div>Purchase</div>
    ...
    Space Dao will launch on ???, you will be able to claim your SPACE token manually on the website. 
    </div>
