      ...
      <Paper className="ohm-card">
        <Box display="flex" flexDirection="column" alignItems="center">
          {/* {parseFloat(poolAwardBalance) === 0 ? (
            ...
            <Box margin={2} textAlign="center">
              <Typography variant="h1">{trim(poolAwardBalance, 2)} sSPACE</Typography>
          ...
          <Typography variant="h6">
            3,3 is the staking reward pool in the Space Dao ecosystem, similar to the Syrup Pool of PancakeSwap. By staking your sSPACE with Space Dao, you will receive token rewards from the partners.
          </Typography>
          {/* {poolIsLocked ? (
