...
const PoolTogether = () => {
  ...
  const [infoTooltipMessage, setInfoTooltipMessage] = useState([
    "Deposit sSPACE to win! Once deposited, you will receive a corresponding amount of 3,3  and be entered to win until your sSPACE is withdrawn.",
  ]);
