...
function TreasuryDashboard() {
  ...
  //   return (state.app.circSupply ?  state.app.treasuryMarketValue / state.app.circSupply : 0);
  // });
  const backingPerOhm = useSelector(state => {
  ...
  useEffect(() => {
    ...
    //     staked: (parseFloat(entry.sOhmCirculatingSupply) / parseFloat(entry.SPACECirculatingSupply)) * 100,
            ...
            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center">
              ...
              <Box className="metric index">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of sSPACE accumulated since the beginning of staking. Basically, how much sSPACE one would have if they staked and held a single OHM from day 1."
                    }
                  />
                </Typography>
                <Typography variant="h5">
                  {currentIndex ? trim(currentIndex, 2) + " sSPACE" : <Skeleton type="text" />}
                </Typography>
              </Box>
            </Box>
          </Paper>
            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <Paper className="ohm-card">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of sSPACE accumulated since the beginning of staking. Basically, how much sSPACE one would have if they staked and held a single SPACE from day 1."
                    }
                  />
                </Typography>
                <Typography variant="h5">
                  {currentIndex ? (
                    trim(currentIndex, 2) + " sSPACE"
                  ) : (
                    <Skeleton type="text" />
                  )}
                </Typography>
