...
query {
  rebases(where: {contract: "0x6E0b8c031f962375F927fE6422845a153517d44D"}, orderBy: timestamp, first: 1000, orderDirection: desc) {
    percentage
    timestamp
  }
}
...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all SPACE staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing SPACE.",
  ...
  holder: "Holders, represents the total number of Ohmies (sSPACE holders)",
  staked: "SPACE Staked, is the ratio of sSPACE to SPACE (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days sSPACE emissions can be sustained at a given rate. Lower APY = longer runway",
};
