...
export function BondTableData({ bond }) {
  ...
  const isBondLoading = !bond.name ?? true;
      ...
      <TableCell align="left">
        <Typography>
          <>
            ...
            {isBondLoading ? <Skeleton width="50px" /> : ((bond.bondPrice) ? trim(bond.bondPrice, 2) : 0) }
          </>
        </Typography>
      </TableCell>
      <TableCell align="left">{isBondLoading ? <Skeleton /> : (bond.bondDiscount) ? `${trim(bond.bondDiscount * 100, 2)}%` : '0%'}</TableCell>
