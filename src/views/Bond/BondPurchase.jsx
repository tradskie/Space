  ...
  async function onBond() {
    if (quantity === "") {
      ...
      const shouldProceed = window.confirm(
        `You are trying to purchase Bond for the address ${shorten(recipientAddress)}, please ensure the wallet address has connected to Space Dao to view the Bond information after purchase succeeds.`,
      );
      if (shouldProceed) {
        await dispatch(
          bondAsset({
        ...
        <Box className="bond-data">
          ...
          <div className={`data-row`}>
            ...
            <Typography id="bond-value-id" className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.bondQuote, 4) || "0"} SPACE`}
            </Typography>
          </div>
          ...
          <div className={`data-row`}>
            ...
            <Typography id="bond-value-id" className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4) || "0"} SPACE`}
            </Typography>
          </div>
          ...
          <div className="data-row">
            ...
            <Typography>
              {isBondLoading ? <Skeleton width="100px" /> : (bond.bondDiscount) ? `${trim(bond.bondDiscount * 100, 2)}%` : '0%'}
            </Typography>
          </div>
          ...
          <div className="data-row">
            ...
            <Typography>
              {isBondLoading ? <Skeleton width="100px" /> : (bond.debtRatio) ? `${trim(bond.debtRatio / 10000000, 4)}%` : '0%'}
            </Typography>
          </div>
